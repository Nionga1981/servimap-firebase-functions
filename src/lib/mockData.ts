...
export const mockDemoUsers: DemoUser[] = [
  { id: 'currentUserDemoId', isPremium: true, name: 'Usuario Premium Demo', idiomaPreferido: 'es', ubicacionExacta: USER_FIXED_LOCATION, puntosAcumulados: 150, historialPuntos: [{ tipo: 'ganados', puntos: 150, fecha: Date.now() - 86400000, servicioId: 'serv123', descripcion: 'Servicio Plomería Urgente' }], favoritos: ['plumber1', 'gardener1'], codigoPropio: 'INVITA123', comisionesAcumuladas: 25.50, historialComisiones: [{servicioId: 'serv_abc', prestadorId: 'plumber1', montoComision: 12.00, fecha: Date.now() - 86400000 * 2}, {servicioId: 'serv_xyz', prestadorId: 'gardener1', montoComision: 13.50, fecha: Date.now() - 86400000 * 4}], referidos: ['plumber1', 'gardener1'], isBlocked: false, bonosRecibidos: {}, balanceBonos: 0 },
...
export const mockRelaciones: RelacionUsuarioPrestador[] = [
  { id: 'rel1', usuarioId: 'standardUserDemoId', prestadorId: 'plumber1', serviciosContratados: 2, ultimoServicioFecha: Date.now() - (1000 * 60 * 60 * 24 * 15), categoriasServicios: ['plumbing'], lastReminderSent: Date.now() - (1000 * 60 * 60 * 24 * 5) },

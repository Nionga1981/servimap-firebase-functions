...
export const SERVICE_CATEGORIES: ServiceCategory[] = [
  ...
  { id: 'cleaning', name: 'Limpieza', icon: Sparkles, keywords: ['limpieza', 'aseo', 'domestico', 'limpiar'] },
  ...
  { id: 'child_care', name: 'Cuidado de Niños', icon: Baby, keywords: ['cuidado de niños', 'niñera', 'bebes', 'infantil'] },
